...
tasks {
    ...
    register<TaskPublishCurseForge>("publishCurseForge") {
        ...
        file.displayName = "[${project.extra["minecraft_version"] as String}] Troll Commands"
...
modrinth {
    ...
    projectId.set("troll-commands")
    uploadFile.set(tasks.remapJar)
    gameVersions.addAll(project.extra["minecraft_version"] as String)
    versionName.set("[${project.extra["minecraft_version"] as String}] Troll Commands")
    dependencies {
